        ...
        public SpawnedGangMember SpawnGangMember(Gang ownerGang, Vector3 spawnPos, SuccessfulMemberSpawnDelegate onSuccessfulMemberSpawn = null, bool spawnWithWeaponEquipped = false)
        {
            ...
            if (ownerGang.memberVariations.Count > 0)
            {
                ...
                if (newPed != null)
                {
                    ...
                    newPed.SetConfigFlag(PedConfigFlagToggles.DontActivateRagdollFromBulletImpact, !ModOptions.instance.gangMembersRagdollWhenShot);
                    newPed.SetConfigFlag(PedConfigFlagToggles.ForceRagdollUponDeath, ModOptions.instance.gangMembersAlwaysRagdollOnDeath);
                    
                    // this one is an attempt to mitigate crashes caused by too many bodies around
                    newPed.SetConfigFlag(PedConfigFlagToggles.BlocksPathingWhenDead, false);
